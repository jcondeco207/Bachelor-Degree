...
void Insert( char *Key, int freq, HashTable H ){
    ...
    if( Pos == NULL )   /* Key is not found */{
        ...
        if( NewCell == NULL )
            ...
            L = H->TheLists[ Hash( Key, H->TableSize ) ];
            Position P = L;
            while(P->Next != NULL && freq < P->Next->Freq){ //Avança na Lista até encontrar uma palavra com frequencia de uso menor que a que se quer inserir
                P = P->Next;
            }
            //Faz as ligações necessárias entre os elementos da lista
            NewCell->Next = P->Next;
